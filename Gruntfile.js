// Generated on 2016-08-16 using generator-angular 0.14.0
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      js: {
        files: ['<%= yeoman.app %>/scripts/{,*/}*.js', '<%= yeoman.app %>/config.js'],
    ...
    imagemin: {
      dist: {
        files: [{
          ...
          src: ['{,*/}*.{png,jpg,jpeg,gif}', '!favicons/*', '!bancos_chile/*', '!bancos_colombia/*'],
